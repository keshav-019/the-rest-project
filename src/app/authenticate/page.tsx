      ...
      >
        ...
        <form onSubmit={handleEmailPasswordSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button 
              type="button"
              className="flex items-center justify-center gap-2 bg-white border border-gray-300 rounded-lg py-2.5 px-4 text-gray-700 font-medium hover:bg-gray-50 transition-colors duration-150 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-70"
            ...
            <button 
              type="button"
              className="flex items-center justify-center gap-2 bg-gray-900 rounded-lg py-2.5 px-4 text-white font-medium hover:bg-gray-800 transition-colors duration-150 cursor-pointer focus:outline-none focus:ring-2 focus:ring-gray-500 disabled:opacity-70"
